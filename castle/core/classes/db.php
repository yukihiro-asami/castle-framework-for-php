...
class DB extends Castle
{
    ...
    public function commit_transaction(int $database_index = CSL_DB_INSTANCE_PRIMARY): bool
    {
        return static::_db_instance($database_index)->commit_transaction();
    }
    public function rollback_transaction(int $database_index = CSL_DB_INSTANCE_PRIMARY): bool
    {
        return static::_db_instance($database_index)->commit_transaction();
    }
